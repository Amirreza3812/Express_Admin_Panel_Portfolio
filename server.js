...
//app.use("/api/admins", adminsRoutes); // این دو روت اضافن از قبلیان پایین آتنتیکیشن روتش مشخصه
...
//   }
// };
// این ui کصشعر سووگر رو هم کامنت کردم این پایین هم توی ستاپ حذف کردم اسمشو
